"""GenresView thread cleanup behavior tests."""

from types import SimpleNamespace
from unittest.mock import MagicMock

import ui.views.genres_view as genres_view_module
...
def test_stop_load_worker_uses_cooperative_shutdown(monkeypatch):
    ...
    monkeypatch.setattr(genres_view_module, "isValid", lambda _obj: True)

    GenresView._stop_load_worker(view, wait_ms=250, clear_ref=True)
